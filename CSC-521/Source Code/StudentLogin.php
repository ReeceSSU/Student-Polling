<?php
	...
	if(isset($_POST['username'])){
        ...
        $query="SELECT * FROM Student WHERE Username='".$_SESSION['uname']."'AND Password='".$_SESSION['password']."' LIMIT 1";
...
<html>
	...
	<form method="POST" action="#">
	  <div class="imgcontainer">
		<img src="Images/img_student.png" alt="student" class="student">
	  </div>
