...
<?php
    $query="SELECT Course.CourseID, Course.CourseName, Class.ClassID, Class.Semester, Class.Year 
                FROM Class, Course, Instructor 
                    WHERE Class.TID = Instructor.TID  AND Course.CourseID = Class.CourseID
                        AND Instructor.Username ='".$_SESSION['uname']."'";
...
<form method="POST">
    <select name="Class">
        ...
        if(isset($_POST['Class'])) {
            ...
            header("Location: InstructorsClass.php");
        }
